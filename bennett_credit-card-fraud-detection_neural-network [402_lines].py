#Author: God Bennett/AdaLabsAdaLabs. (My name was legally changed from Jordan Bennett) Bennett


#Original Code (55 lines) by Manuel on Kaggle: https://www.kaggle.com/manoloesparta/neural-network-accuracy-99-93


#Modified Code (402 lines) by God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett) Bennett/AdaLabs.

 
#God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett) wrote code to:
...
#2. Perform crucial machine learning driven data imputation, since The Jamaican Bank's transaction data may have missing values.
...
# Note by God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett): Uses python 3.6, Requires keras, matplotlib, pandas, sklearn, numpy and tensorflow installations to python.
...
###############################################
#begin God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to report start time
import datetime
print('start time '+str(datetime.datetime.now()))
#end God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to report start time
###############################################


# read data

data = pd.read_csv('data/export_300k_v2_maskedThe Jamaican Bank'sColumns.csv') #Edited by God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett) to point to local creditcard directory


###############################################God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_0
#begin God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code impute missing values using BayesianRidge
...
###############################################end God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_0


###############################################God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_1
#Begin God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to render pie visualization of fraudulent transactions vs non-fraudlent transactions wrt training data
...
#End God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to render pie visualization of fraudulent transactions vs non-fraudlent transactions wrt training data
###############################################end God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_1


###############################################begin God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to specify dimensions before training
inputDimensions = 65 ##Corresponds to number of non-class columns in The Jamaican Bank's input data file.
##end God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett) code to specify dimension before training
...
#God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_edit: initializers changed from uniform to lecun_normal alternative kernel_initializer from pool of initializers at documentation site: https://keras.io/initializers/
...
#end God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett) modification.
...
###############################################God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_2
#Begin God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to render pie visualization of fraudulent transactions vs non-fraudlent transactions wrt trained neural network
...
#End God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to render pie visualization of fraudulent transactions vs non-fraudlent transactions wrt trained neural network
###############################################end God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_2



###############################################God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_3
#God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett) function 3 to add online inference or real time test capability to the model.
"""
...
##############################################end God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_3
...
###############################################God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_5
####God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett) function 5 to produce confusion matrix based on the neural network output.
"""
...
"""
###############################################God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_6
#Begin God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to render tSNE visualization of fraudulent transactions vs non-fraudlent transactions wrt trained neural network
...
#End God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to render tSNE visualization of fraudulent transactions vs non-fraudlent transactions wrt trained neural network
###############################################end God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_6
"""


###############################################God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_7 save and load model
...
###############################################end God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_function_7
...
###############################################
#begin God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to report end time
print('end time '+str(datetime.datetime.now()))
#end God Bennett/AdaLabs. (My name was legally changed from Jordan Bennett)_code to report end time
###############################################
